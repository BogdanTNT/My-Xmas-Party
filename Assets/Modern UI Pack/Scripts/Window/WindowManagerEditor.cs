...
namespace Michsky.UI.ModernUIPack
{
    ...
    public class WindowManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                string nam = wmTarget.windows[i].windowName;

                if (wmTarget.windows[i].windowObject != null)
                {
                    wmTarget.windows[i].windowObject.name = nam;
                    Transform b = wmTarget.windows[i].buttonObject.transform;

                    b.Find("Pressed/Text").GetComponent<TMPro.TMP_Text>().text = nam;
                    b.Find("Normal/Text").GetComponent<TMPro.TMP_Text>().text = nam;
                ...
                case 1:
                    ...
                    if (wmTarget.windows.Count != 0)
                    {
                        ...
                        for(int i = 0; i < wmTarget.windows.Count; i++)
                        {
                            ...
                            {
                                wmTarget.windows[i].windowObject.gameObject.GetComponent<CanvasGroup>().alpha = 0;
                            }
                            else
                            {
                                wmTarget.windows[i].windowObject.gameObject.GetComponent<CanvasGroup>().alpha = 1;
                            }
                        }
